  ...
  return (
    <>
      {creatingOrder ? (
        ...
        <div className="mt-5 form__container d-flex containerFormBuyer">
          <div className="container align-self-center position-relative">
            <h2>Checkout</h2>
            <form
              className="row my-5 containerForm"
            ...
            >
              ...
              <div className=" col-md-6 mb-5 d-flex flex-column align-items-center">
                ...
                <input
                  ...
                  className="form-control form-control--color"
                  name="email"
                  placeholder="ignacio@ejemplo.com"
              ...
              <div className="col-md-12 d-flex justify-content-center">
                <button
                  className="btn btn-success bg-gradient d-flex justify-content-center align-self-center w-20"
                  disabled={
                    !formData.name ||
                    !formData.phone ||
                    !formData.email ||
